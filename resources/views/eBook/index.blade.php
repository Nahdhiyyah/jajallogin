                                            ...
                                            <td class="text-center">
                                                <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                                    ...
                                                    <a href="{{ route('buku.edit', $buku->id) }}"
                                                        class="btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#0066cc" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                                ...
                                                <td>
                                                    <form>
                                                    @method('DELETE')
                                                    <button type="submit" class="btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="red" class="bi bi-trash" viewBox="0 0 16 16">
